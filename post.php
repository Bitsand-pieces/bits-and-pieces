    ...
    if(isset($_POST['donate_btn']) && !empty($_POST['dType'])){
        ...
        $username=$_SESSION['name'];
            ...
            foreach($dType as $selected){
                ...
                $postInsert="INSERT INTO `posts`(`user_id`, `dType_id`, `objectName`, `objectImg`, `quantity`, `shrt_desc`, `comp_desc`) VALUES ('".$user_id."','".$dTypeId."','".$objectName."','".$objectImg."','".$quantity."','".$shrt_desc."','".$comp_desc."')";
...
<form action="" method="post" enctype="multipart/form-data">
    ...
    <div class="form">
        ...
        <input type="text" class="input" name="objectName" placeholder="Name of the object or food you are donating" required>
    </div>
    ...
    <div class="form">
        ...
        <textarea class="textarea" maxlength="500" name="shrt_desc" placeholder="Short Description(not more than 100words)" required></textarea>
    </div>
    <div class="form">
